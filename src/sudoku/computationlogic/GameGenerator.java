...
public class GameGenerator {
    ...
    private static int[][] getSolvedGame() {
        ...
        for (int value = 1; value <= GRID_BOUNDARY; value++) {
            ...
            //As a safetynet, if we keep rolling back allocations on the most recent frame, and the game still
     ...
     * and randomly assign a certain number of tiles to be equal to 0.
